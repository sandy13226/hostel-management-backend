# Backend GitHub Push Script
$env:Path += ";C:\Program Files\Git\cmd"

Write-Host ""
Write-Host "=======================================" -ForegroundColor Cyan
Write-Host "  Backend Repository - GitHub Setup" -ForegroundColor Cyan
Write-Host "=======================================" -ForegroundColor Cyan
Write-Host ""

# Navigate to backend
cd c:\Users\ELCOT\Downloads\demo\demo\backend

# Repository name suggestion
$repoName = "hostel-management-backend"
...
Write-Host "3. Description: Spring Boot backend for Hostel Management System" -ForegroundColor White
